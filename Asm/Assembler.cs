...
public class Assembler
{
    ...
    public (string, int) GetExternalFunction(int index)
    {
    ...
    {
        return sourceCodeLineMap.TryGetValue((fileName, line), out int ip) ? ip : -1;
    }
    ...
    public void EmitDupPtr()
    {
        writer.Write((byte) Opcode.DUPPTR);
    }
    ...
    public void EmitScanDynamicString()
    {
        writer.Write((byte) Opcode.DSCANSTR);
    }
